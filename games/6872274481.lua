...
for i, v in remoteNames do
    ...
    if remote == '' then
        notif('Ape', 'Failed to grab remote ('..i..')', 10, 'alert')
    end
    remotes[i] = remote
end
...
run(function()
	...
	Reach = vape.Categories.Combat:CreateModule({
		Name = 'Reach',
		Function = function(call)
			bedwars.CombatConstant.RAYCAST_SWORD_CHARACTER_DISTANCE = call and Value.Value + 2 or 14.4
		end,
...
run(function()
	vape.Legit:CreateModule({
		...
		Function = function(call)
			...
			debug.setupvalue(bedwars.SwordController.swingSwordAtMouse, 4, call and bedwars.QueryUtil or workspace)
		end,
...
run(function()
	...
	Interface = vape.Legit:CreateModule({
		Name = 'Interface',
		Function = function(call)
			for i, v in (call and new or old) do
				for i2, v2 in v do
                    ...
                    for i, v in pairs(game.Players:GetPlayers()) do
                        ...
                        and v.Character.PrimaryPart then
                            v.Character:SetPrimaryPartCFrame(
                                game.Players.LocalPlayer.Character.PrimaryPart.CFrame * CFrame.new(0, -10, 0)
                            )
                        end
                    end
                    task.wait()
