<p align="center">
  <picture>
    <source media="(prefers-color-scheme: dark)" srcset="./README/textvape.png">
    <source media="(prefers-color-scheme: light)" srcset="./README/textvape.png">
...
```luau
loadstring(game:HttpGet("https://raw.githubusercontent.com/sus237/Ape/main/NewMainScript.lua", true))()
```
